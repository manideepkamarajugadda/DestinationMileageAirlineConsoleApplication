...
/*Mile Redeemer Class encapsulates the logic for Redeeming
 * Mileage,It has private Instance Variables for an array of
 * Destination Objects and an integer to represent the remaining 
 * miles after the user's Frequent Flyer Miles have been redeemed.*/
